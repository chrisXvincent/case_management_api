...
def queryData():
    ...
    try:
        ...
        try:
            ...
            a = [i for i, j in business_dict.items() if j == business_name]
            b = [i for i, j in module_dict.items() if j == module_name]
            business_id, module_id = (a[0] if a else '', b[0] if b else '')
            ...
            query_data = case_list.query.filter(
                ...
                or_(case_list.business_id == business_id, business_id == ''),
                or_(case_list.module_id == module_id, module_id == ''),
...
def add_case():
    ...
    try:
        ...
        try:
            ...
            case_title = new_data['case_title']
